...
### Dates:
The next edition of the course will take place on August 25th, 26th, and 27th in Copenhagen, Denmark. Pre-registration will open at the end of May.
...
Prior to the course, it is required to install the latest [Dymola trial version](https://www.3ds.com/products-services/catia/products/dymola/trial-version/) (2024x Refresh 1) and the [Modelica Buildings Library](https://simulationresearch.lbl.gov/modelica/download.html) (v11.0.0). The instructions to access the non-trial license will be provided at the beginning of the course. 
