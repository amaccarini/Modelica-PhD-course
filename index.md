...
### Dates:
The next edition of the course will take place August 26–28, 2026.
...
### Fee:
UPDATE (22 May 2026): The course is free of charge for students and academic staff affiliated with Danish universities. Participants from non-Danish universities and industry are required to pay a participation fee of 6000 DKK (approximately 800 EUR).
...
The course will be delivered using [Modelon Impact](https://modelon.com/modelon-impact/) and the [Modelica Buildings Library](https://simulationresearch.lbl.gov/modelica/). All instructions for accessing the platform will be provided at the beginning of the course. There is no need to install any software in advance.
